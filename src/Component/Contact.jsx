...
const Contact = () => {
  return (
    ...
    <Text mb="25px" textAlign="center" fontWeight="400" fontSize={["3xl", "4xl", "5xl"]}color={"#00b9e8"} mt={"10%"}>Contact Me</Text>
...
<Stack>
  <Text  color={"#00b9e8"} fontSize={["20px","25px","30px"]}textAlign={["center","center","left"]}>Get in Touch</Text>
<Text fontSize={["14px","15px","20px"]} color={"white"}   display={["none","none","center"]} >Got a project? Reach out and let's work together</Text>
...
<form action="https://getform.io/f/f2cad863-a312-464c-bf76-973911fa56e1" method="POST">
<Box  w={["70%","70%","90%"]}  mt={["100px","100px","0px"]} h={"400px"} ml={["70px","100px","-5%"]}>
  <Stack>
<Stack >
<Text color={"#00b9e8"} fontSize={["20px","25px","30px"]} textAlign={["center","center","left"]} mt={["-10px","",""]}>Message Me</Text>
  <Flex>

<Input type="text" name="name" placeholder='Name' size={['md',"lg",'lg']} color={"white"}/>
<Input type="email" name="email" placeholder='Email' size={['md',"lg",'lg']} color={"white"} ml={"20px"}/>
</Flex>
</Stack>

<Stack  mt={"20px"} >
<Input  type="number" name="number" placeholder='Mobile Number' size={['md',"lg",'lg']} color={"white"} m={"auto"} mt={"8%"}/>

</Stack>

<Stack  mt={"20px"} >
<Textarea  type="text" name="message" placeholder='Message' size={['md',"lg",'lg']}  color={"white"} m={"auto"} mt={"8%"}/>
</Stack>
<Stack  mt={"20px"} >
<Button type="submit" w={["50%","30%","50%"]} h={["35px","40px","45px"]}  mt={"5%"} ml={["56px","170px","100px"]} size="lg" color={"black"} fontSize={["15px","19px","20px"]} bg={"white"} _hover={{
    background: "#00b9e8",
    color: "black",
  }}>Send</Button>
</Stack>
